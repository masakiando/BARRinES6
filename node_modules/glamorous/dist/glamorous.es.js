...
function getGlamorClassName$1(styles, props, cssOverrides, theme) {
  ...
  var glamorClassName = css.apply(undefined, mappedArgs.concat(toConsumableArray(parentGlamorStyles), [cssOverrides])).toString();
...
export { ThemeProvider, withTheme };export default glamorous;
